  ...
  return (
    <AppShell sidebar={sidebar} header={header}>
      ...
      <Modal isOpen={showBrainDump} onClose={() => setShowBrainDump(false)}>
        <div className="bg-white rounded-3xl p-10 w-[90vw] max-w-6xl min-h-[60vh]">
      ...
      <Modal isOpen={showFeedback} onClose={() => setShowFeedback(false)}>
        <div className="bg-white rounded-3xl p-10 w-[90vw] max-w-5xl min-h-[60vh]">
          <div className="flex justify-between items-center mb-6">
          ...
          <div className="space-y-4">
            <textarea
              className="w-full min-h-[320px] p-4 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
